...
import { META_PIXEL_ID, metaPixelBaseScript } from "@/lib/meta-pixel";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI App Builder Course" },
      {
        name: "description",
        content:
          "Build, publish and monetize Android apps using AI tools with live 1-to-1 mentorship.",
      },
      { property: "og:title", content: "AI App Builder Course" },
      {
