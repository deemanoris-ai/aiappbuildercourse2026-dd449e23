  ...
  head: () => ({
    meta: [
      { title: "AI App Builder Course — Build Android Apps with AI, No Code" },
      {
        name: "description",
        content:
          "Learn to build, publish and monetize Android apps using AI tools with live 1-to-1 mentorship. Lifetime access, bonus courses and resources for ₹2499.",
      },
      { property: "og:title", content: "AI App Builder Course — Build Android Apps with AI" },
      {
        property: "og:description",
        content:
          "Step-by-step AI app building with live mentorship, lifetime access and free bonus courses. Enroll for ₹2499.",
      },
